import pytest
from evid.core.label_setup import clean_text_for_typst, textpdf_to_typst, text_to_typst, json_to_bib, load_uuid_prefix, load_url
import fitz
...
def test_json_to_bib(tmp_path):
    ...
    data = [{"value": {"key": "key1", "text": "quote", "title": "title", "date": "2023-01-01", "opage": 1, "note": "note"}}]
